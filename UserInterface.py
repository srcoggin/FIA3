...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Search_Patient_Button = QtWidgets.QPushButton(self.widget3)
        self.Search_Patient_Button.setMinimumSize(QtCore.QSize(120, 30))
        self.Search_Patient_Button.setMaximumSize(QtCore.QSize(120, 30))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.Search_Patient_Button.setFont(font)
        self.Search_Patient_Button.setObjectName("Search_Patient_Button")
        self.horizontalLayout_15.addWidget(self.Search_Patient_Button)
        ...
        self.Search_Patient_Button_2 = QtWidgets.QPushButton(self.widget4)
        self.Search_Patient_Button_2.setMinimumSize(QtCore.QSize(120, 30))
        self.Search_Patient_Button_2.setMaximumSize(QtCore.QSize(120, 30))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.Search_Patient_Button_2.setFont(font)
        self.Search_Patient_Button_2.setObjectName("Search_Patient_Button_2")
        self.horizontalLayout_19.addWidget(self.Search_Patient_Button_2)
...
"Conveniently located in the heart of the Bundaberg region, our modern clinic provides a warm and inviting space for your physiotherapy sessions. We also offer telehealth services, allowing you to receive expert guidance and support from the comfort of your own home."))
        ...
        self.Search_Patient_Button.setText(_translate("Form", "Search Patient"))
        self.label_11.setText(_translate("Form", "Next Page:"))
        self.Search_Patient_Button_2.setText(_translate("Form", "Next Page"))
